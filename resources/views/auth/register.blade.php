            ...
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="px-5 ms-xl-4">
                        ...
                        <span class="h1 fw-bold mb-0"><img src="{{ asset('img/logo.svg') }}" class="w-40 vh-40" width="180" height="180"></span>
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        <form style="width: 23rem;" action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <label class="form-label" for="">Input your name</label>
                            </div>

                            <div class="form-outline mb-4">
                                <input type="email" id="" class="form-control form-control-lg" name="email"/>
                                <label class="form-label" for="">Input your email</label>
                            </div>

                            <div class="form-outline mb-4">
                                <input type="password" id="" class="form-control form-control-lg" name="password"/>
                                <label class="form-label" for="">Input your password</label>
                            </div>
