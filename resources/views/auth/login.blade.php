            ...
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="px-5 ms-xl-4">
                        ...
                        <span class="h1 fw-bold mb-0"><img src="{{ asset('img/logo.svg') }}" class="w-40 vh-40" width="250" height="250"></span>
                    </div>

                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 pt-xl-0 mt-xl-n5">
                        <form style="width: 23rem;" action="{{ route('login.authenticate') }}" method="POST">
                            @csrf

                            <h3 class="fw-normal mb-3 pb-3 mt-5" style="letter-spacing: 1px;">Sign in</h3>
